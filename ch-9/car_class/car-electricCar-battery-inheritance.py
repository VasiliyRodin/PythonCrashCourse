''' This creates the '''"""Every attribute in a class needs an initial value, even if that value is 0 or an empty string. 
...
#Doesn't inherit anything but can be used as a attribute in another class. 
class Battery():
    def __init__(self, battery_capacity=80):
        self.battery_capacity = battery_capacity
    def display_battery_capacity(self):
        print("Electric Cars Battery Capacity: " + str(self.battery_capacity))
...
class ElectricCar(Car):
    def __init__(self, make, model, year):
        ...
        #Supposed to create battery witht 
...
my_tesla.battery.battery_capacity = 100
print(my_tesla.battery.display_battery_capacity())
